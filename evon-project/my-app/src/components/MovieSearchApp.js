...
// https://api.themoviedb.org/3/movie/550?api_key=dd3c536a0bc0792e21bd96adab6fe55b
// https://api.themoviedb.org/3/search/movie?api_key=dd3c536a0bc0792e21bd96adab6fe55b&query=''
...
const MovieSearchApp = () => {
  ...
  return (
    <div className="p-10">
      <div className="x-full max-w-[500px] mx-auto mb-20">
        <input
          type="text"
      ...
      <div className="grid grid-cols-3 gap-10">
        {movies.length > 0 &&
          movies.map((item, index) => (
            <MovieItem key={index} data={item}></MovieItem>
          ))}
      </div>
    </div>
  );
      ...
      <div className="h-[297px]">
        <img
          src={`https://image.tmdb.org/t/p/original${
            data.poster_path !== null ? data.poster_path : ""
          }`}
          alt=""
